...
[Mã nguồn tích hợp](https://github.com/nguyenlebinhan/AI_Hackathon) ·
[Backend](https://github.com/nguyenlebinhan/AI_Hackathon/tree/SU) ·
[Frontend](https://github.com/nguyenlebinhan/AI_Hackathon/tree/feature/frontend) ·
[Figma Prototype](https://www.figma.com/design/b7Egr7gD623CWdrn6JdVpK/VADS---Prototype) ·
[API Catalog](https://github.com/nguyenlebinhan/AI_Hackathon/blob/main/docs/api-catalog.md)
...
| Semantic diff có kiểu | Phân biệt `VALUE_CHANGED`, `RESPONSIBILITY_CHANGED`, `UNCHANGED`; lưu old/new evidence | [`regulatory_change/diff.py`](https://github.com/nguyenlebinhan/AI_Hackathon/blob/main/app/regulatory_change/diff.py) |
| Tác động giải thích được | Không dùng một similarity score duy nhất; kết hợp domain, budget, stage, department, legal basis và thời gian | [`regulatory_change/impact.py`](https://github.com/nguyenlebinhan/AI_Hackathon/blob/main/app/regulatory_change/impact.py) |
| Không bịa dữ liệu thiếu | Không có phiên bản trước thì hệ thống trả `NEEDS_HUMAN_REVIEW`, không tự tạo thay đổi | [`test_regulatory_change_vertical_slice.py`](https://github.com/nguyenlebinhan/AI_Hackathon/blob/main/app/tests/test_regulatory_change_vertical_slice.py) |
...
[`test_two_versions_diff_project_impact_and_agent_audit`](https://github.com/nguyenlebinhan/AI_Hackathon/blob/main/app/tests/test_regulatory_change_vertical_slice.py).
...
```bash
git clone https://github.com/nguyenlebinhan/AI_Hackathon.git
cd AI_Hackathon
cp .env.example .env
...
- [VADS Postman collection](https://github.com/nguyenlebinhan/AI_Hackathon/blob/main/docs/postman/VADS.postman_collection.json);
- [Regulatory Change collection](https://github.com/nguyenlebinhan/AI_Hackathon/blob/main/docs/postman/Regulatory-Change-Vertical-Slice.postman_collection.json);
- [VADS Local environment](https://github.com/nguyenlebinhan/AI_Hackathon/blob/main/docs/postman/VADS.postman_environment.json).
...
[`docs/api-catalog.md`](https://github.com/nguyenlebinhan/AI_Hackathon/blob/main/docs/api-catalog.md).
...
[`docs/deploy-railway.md`](https://github.com/nguyenlebinhan/AI_Hackathon/blob/main/docs/deploy-railway.md).
...
- **Repository chính:** <https://github.com/nguyenlebinhan/AI_Hackathon>
- **Nhánh backend:** <https://github.com/nguyenlebinhan/AI_Hackathon/tree/SU>
- **Nhánh frontend:** <https://github.com/nguyenlebinhan/AI_Hackathon/tree/feature/frontend>
- **Kiến trúc Regulatory Change:** [docs/regulatory-change-architecture.md](https://github.com/nguyenlebinhan/AI_Hackathon/blob/main/docs/regulatory-change-architecture.md)
...
- **Figma prototype:** <https://www.figma.com/design/b7Egr7gD623CWdrn6JdVpK/VADS---Prototype>
- **Contributors:** <https://github.com/nguyenlebinhan/AI_Hackathon/graphs/contributors>
